...
import { OMNIDEF } from './sampleCaseManagementEnglish_def.js';
import tmpl from './sampleCaseManagementEnglish.html';
import tmpl_nds from './sampleCaseManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleCaseManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
