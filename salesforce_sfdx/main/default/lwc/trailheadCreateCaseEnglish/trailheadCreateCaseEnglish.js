...
import { OMNIDEF } from './trailheadCreateCaseEnglish_def.js';
import tmpl from './trailheadCreateCaseEnglish.html';
import tmpl_nds from './trailheadCreateCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class trailheadCreateCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
