...
import { OMNIDEF } from './trailheadCaseManagementEnglish_def.js';
import tmpl from './trailheadCaseManagementEnglish.html';
import tmpl_nds from './trailheadCaseManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class trailheadCaseManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
